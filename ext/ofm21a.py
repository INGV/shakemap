...
class OFM21A(GMICE):
    ...
    Oliveti Faenza Michelini (2021).

    References:
        Oliveti Faenza Michelini,(2021). Quadratic reversible relationships
        between ground motion parameters and MCS intensity for Italy
    ...
    def __init__(self):
        ...
        self.scale = 'scale_ofm21a.ps'
        self._constants = {
            self._pga: {'C1':  3.05, 'C2':  0, 'C3':  0.85, 'D1': 3.05, 'D2': 2.58, 'IL': 3.05, 'SMMI': 0.38, 'SPGM': 0.37},
            self._pgv: {'C1':  4.31, 'C2':  1.94, 'C3':  0.61, 'D1': 6.50, 'D2': 2.35, 'IL': 2.77, 'SMMI': 0.41, 'SPGM': 0.47},
            self._sa03: {'C1':  2.81, 'C2':  0, 'C3':  0.67, 'D1': 2.81, 'D2': 2.47, 'IL': 2.81, 'SMMI': 0.36, 'SPGM': 0.42},
            self._sa10: {'C1':  3.04, 'C2':  0.86, 'C3':  0.52, 'D1': 4.39, 'D2': 2.05, 'IL': 2.68, 'SMMI': 0.38, 'SPGM': 0.59},
            self._sa30: {'C1':  4.10, 'C2':  1.63, 'C3':  0.61, 'D1': 5.68, 'D2': 2.00, 'IL': 3.02, 'SMMI': 0.27, 'SPGM': 0.50}
        }
